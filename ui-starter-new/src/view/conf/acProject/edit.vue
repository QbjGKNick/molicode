  ...
  <div>
    <Modal v-model="showModal"
      ...
      <Form ref="formItems" :model="formItems" :rules="formRules" :label-width="120" inline>
        ...
        <Row>
          <Col span="24">
            <Form-item label="备注" prop="remark" style="width: 90%">
              <Input v-model="formItems.remark" :maxlength="500" type="textarea" :autosize="{minRows: 2,maxRows: 5}"
        ...
        <Row>
          <Col span="24">
            <Form-item label="项目类型" prop="type" style="width: 90%">
              <dict-select v-model="formItems.type"
