      ...
      <Row>
        <Col span="24">
          <Form-item label="数据库名称" prop="databaseName" style="width: 95%">
            <dict-select
              v-model="formItems.databaseName"
...
var defConfig = {
  ...
  url:
    "jdbc:mysql://127.0.0.1:3306/auto-code?useUnicode=true&characterEncoding=UTF8",
  username: "root",
  password: ""
};
  ...
  methods: {
    ...
    testConnection: function() {
      ...
      this.$refs["formItems"].validate(valid => {
        ...
        requestUtils.postSubmit(
          this,
          constants.urls.common.database.testConnection,
          this.getConfigData(),
          function(data) {
            this.$Message.success({
              content: "链接数据库成功",
