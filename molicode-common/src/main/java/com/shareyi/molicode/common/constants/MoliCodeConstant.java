...
public class MoliCodeConstant {
     ...
     * 默认的自定义fields分组列表
     */
    public static final List<CustomFieldGroup> DEFAULT_CUSTOM_FIELD_GROUP_LIST = Lists.newArrayListWithCapacity(10);


    static {

        DEFAULT_CUSTOM_FIELD_GROUP_LIST.add(CustomFieldGroup.create(BIZ_FIELDS_KEY_CREATETIME, "创建时间", false,
                "gmtCreate,created"));
        DEFAULT_CUSTOM_FIELD_GROUP_LIST.add(CustomFieldGroup.create(BIZ_FIELDS_KEY_UPDATETIME, "修改时间", false,
                "gmtModify,modified"));
        DEFAULT_CUSTOM_FIELD_GROUP_LIST.add(CustomFieldGroup.create(BIZ_FIELDS_KEY_SEARCHKEY, "查询条件", true,
                "*name,*state,*status,*type,*key"));
        DEFAULT_CUSTOM_FIELD_GROUP_LIST.add(CustomFieldGroup.create(BIZ_FIELDS_KEY_QUERYLIST, "查询列表", true,
                "^gmtCreate,created,*note,*remark"));
        DEFAULT_CUSTOM_FIELD_GROUP_LIST.add(CustomFieldGroup.create(BIZ_FIELDS_KEY_ADDLIST, "新增", true,
                "^gmtCreate,created,gmtModify,modified"));
        DEFAULT_CUSTOM_FIELD_GROUP_LIST.add(CustomFieldGroup.create(BIZ_FIELDS_KEY_UPDATELIST, "修改", true,
                "^gmtCreate,created,gmtModify,modified"));
        DEFAULT_CUSTOM_FIELD_GROUP_LIST.add(CustomFieldGroup.create(BIZ_FIELDS_KEY_VIEWLIST, "查看", true,
                ""));
    }
